...
static const MagicalAll Biora("Biora", 1.25, Rule::StatusAilment);
static const MagicalAll Bioga("Bioga", 1.4, Rule::StatusAilment);
static const MagicalAll Blizzaga("Blizzaga", 1.8);
static const MagicalAll Blizzara("Blizzara", 1.4);
...
static const MagicalAll Stonga("Stonga", 1.8);
...
static const MagicalAll Watera("Watera", 1.4, Rule::Water);
